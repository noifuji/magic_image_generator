...
class FetchCardImagesUsecase {
  Future<List<List<CardInfoHeader>>> call(List<List<CardInfoHeader>> cards, Locale locale) async {
  ...
  Future<ui.Image?> rotate(ui.Image image, double radian) async {
    ...
    ui.Codec codec = await ui.instantiateImageCodec(img.encodePng(rotatedImage));
