...
class SearchFilterFactory {
  static SearchFilterData createSearchFilter(
    ...
    /****Sets****/
      ...
      return SearchFilterData(
          filter: sf,
          name: AppLocalizations.of(context)!.setOm1,
          searchValue: "om1",
          searchKey: "set",
          filterType: SearchFilterType.set);
    }
      ...
      return SearchFilterData(
          filter: sf,
          name: AppLocalizations.of(context)!.setFin,
          searchValue: "fin",
          searchKey: "set",
          filterType: SearchFilterType.set);
    }
    else if (sf == SearchFilter.setTdm) {
      return SearchFilterData(
          filter: sf,
          name: AppLocalizations.of(context)!.setTdm,
          searchValue: "tdm",
          searchKey: "set",
          filterType: SearchFilterType.set);
    }
      ...
      return SearchFilterData(
          filter: sf,
          name: AppLocalizations.of(context)!.setDsk,
          searchValue: "dsk",
          searchKey: "set",
          filterType: SearchFilterType.set);
    }
      ...
      return SearchFilterData(
          filter: sf,
          name: AppLocalizations.of(context)!.setBig,
          searchValue: "big",
          searchKey: "set",
          filterType: SearchFilterType.set);
    }
    else if (sf == SearchFilter.setOtj) {
      return SearchFilterData(
          filter: sf,
          name: AppLocalizations.of(context)!.setOtj,
          searchValue: "otj",
          searchKey: "set",
          filterType: SearchFilterType.set);
    }
    ...
    /****Sets Alchemy****/
    else if (sf == SearchFilter.setYtdm) {
      return SearchFilterData(
          filter: sf,
          name: AppLocalizations.of(context)!.setYtdm,
          searchValue: "ytdm",
          searchKey: "set",
          filterType: SearchFilterType.set);
    }
    else if (sf == SearchFilter.setYdft) {
      return SearchFilterData(
          filter: sf,
          name: AppLocalizations.of(context)!.setYdft,
          searchValue: "ydft",
          searchKey: "set",
          filterType: SearchFilterType.set);
    }
    else if (sf == SearchFilter.setYdsk) {
      return SearchFilterData(
          filter: sf,
          name: AppLocalizations.of(context)!.setYdsk,
          searchValue: "ydsk",
          searchKey: "set",
          filterType: SearchFilterType.set);
    }
      ...
      return SearchFilterData(
          filter: sf,
          name: AppLocalizations.of(context)!.setYotj,
          searchValue: "yotj",
          searchKey: "set",
          filterType: SearchFilterType.set);
    }
    ...
    /****Sets Supplemental****/
      ...
      return SearchFilterData(
          filter: sf,
          name: AppLocalizations.of(context)!.setFca,
          searchValue: "fca",
          searchKey: "set",
          filterType: SearchFilterType.set);
    } else if (sf == SearchFilter.setJ25) {
      return SearchFilterData(
          filter: sf,
          name: AppLocalizations.of(context)!.setJ25,
          searchValue: "j25",
          searchKey: "set",
          filterType: SearchFilterType.set);
