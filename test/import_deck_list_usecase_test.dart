...
2 Unlicensed Hearse (SNC) 246""";
    ...
    expect(result, 'name="Corpse Appraiser" or name="Bloodtithe Harvester" or name="Sheoldred, the Apocalypse" or name="Unlicensed Hearse"');
  });
...
2 Unlicensed Hearse (SNC) 246""";
    ...
    expect(result, 'name="Sheoldred, the Apocalypse" or name="Unlicensed Hearse"');
  });
...
1 Expanded Anatomy (STX) 2""";
    ...
    expect(result, 'name="Lurrus of the Dream-Den" or name="Selfless Savior" or name="Expanded Anatomy"');
  });
...
1 Sheoldred, the Apocalypse""";
    ...
    expect(result, 'name="Corpse Appraiser" or name="Sheoldred, the Apocalypse"');
  });
...
2 Unlicensed Hearse (SNC) 246""";
    ...
    expect(() => importer.call(deckList,groupMap), throwsA(const TypeMatcher<Exception>()));
  });
