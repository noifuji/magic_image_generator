...
void main() {
  ...
  test('AnalyzeQueryUseCase returns ok when query has whitespace in a row.', () async {
    var query = 'legal:standard      hello r<=u c:r ((o:"you may" and o:next) or o:draw) (t:insta or t:sorce) or t:crea';
    var analyzer = AnalyzeQueryUseCase();
    var result = analyzer.call(query);
  ...
  test('AnalyzeQueryUseCase throws Exception when query has only operator.', () async {
    var query = 'and';
    var analyzer = AnalyzeQueryUseCase();
    expect(() => analyzer.call(query), throwsA(TypeMatcher<Exception>()));
  });

  test('AnalyzeQueryUseCase throws Exception when query in unclosed.', () async {
    var query = 'legal:standard hello r<=u c:r ((o:"you may" and o:next) or o:draw (t:insta or t:sorce) or t:crea';
    var analyzer = AnalyzeQueryUseCase();
    expect(() => analyzer.call(query), throwsA(TypeMatcher<Exception>()));
  });
